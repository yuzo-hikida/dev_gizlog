...
<div class="main-wrap">
  {!! Form::open(['route' => ['question.index'], 'method' => 'GET', 'id' => 'select-question']) !!}
  ...
  <div class="content-wrapper table-responsive">
    <table class="table table-striped">
      ...
      @foreach($questions as $question)
        <tr class="row">
          <td class="col-xs-1"><img src="{{ empty($question->user->avatar) ? 'http://acbio2.acbio.u-fukui.ac.jp/gousei/img/image5.png' : $question->user->avatar }}" class="avatar-img"></td>
